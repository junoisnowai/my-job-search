...
### Identity
- **Name:** Sayed Johon (Academic/Legal Name: Hamim Ahmed)
- **Location:** Dhaka, Bangladesh (Open to Dhaka on-site, hybrid, and global remote contracts)
- **Primary Email:** `contact.sayedjohon@gmail.com`
- **Phone / WhatsApp:** `+8801972072408`
- **Telegram:** `@sayedjohon`
- **Languages:**
  | Language | Level |
  |----------|-------|
